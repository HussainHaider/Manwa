...
public class whish_custom_adapter extends ArrayAdapter<Productdetailclass> {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        txtTitle2.setText(Integer.toString( p.get(position).getPrice()));
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                long c= Helper.removeFromWhish(Integer.toString( p.get(index).getPID()),uid);
                if(c==-1) {
                ...
                {
                    Toast.makeText(context, "Item Removed from Whish Successfully", Toast.LENGTH_SHORT)
                            .show();
