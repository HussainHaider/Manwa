...
public class UpdateUserData {
    ...
    private static String url_update_suspendUser = "https://stopshop321.000webhostapp.com/SuspendUser.php";
    // JSON Node names
    ...
    List<String> SuspendUserList=null;
    ...
    public void SuspendUSer(List<String> mSUserList, Context c)
    {
        SuspendUserList=new ArrayList<>();
        SuspendUserList=mSUserList;

        Log.d("remove","Function()");
        // myDialog= DialogsUtils.showProgressDialog(c,"Checking with Server");
        new SuspendUser().execute();
        //myDialog.dismiss();
    }
    ...
    class SuspendUser extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            for(int i=0;i<UserList.size();i++)
            {
                ...
                params.add(new BasicNameValuePair("user_email",UserList.get(i)));
                String email=null,error_text=null;
                JSONObject json = jsonParser.makeHttpRequest(url_update_suspendUser,
                        "GET", params);
                // check for success tag
